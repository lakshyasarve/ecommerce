...
California (if you are resident)	(a) Right to Know/Access; (b) Right to Correct; (c) Right to Delete; (d) Right to Opt-Out of Sale and Sharing for Targeted Advertising; (f) Right to Limit Use and Disclosure of Sensitive Personal Information; (g) Right to Opt-Out of Automated Decision-making or Profiling (upon issuance of regulations by the California Privacy Protection Agency); (h) Right Against Discrimination.; (i) Right to Portability; and (o) Shine the Light.
Colorado, Connecticut, Virginia; starting 7.1.24 Oregon, Texas (if you are resident)	(a) Right to Know/Access; (b) Right to Correct; (c) Right to Delete; (d) Right to Opt-Out of Sale; (e) Right to Opt-Out of Sharing for Targeted Advertising; (g) Right to Opt-Out of Automated Decision-making or Profiling; (h) Right Against Discrimination; (i) Right to Portability; (l) Right to Withdraw Consent; and (m) Right to Appeal.
European Economic Area, United Kindom, or Switzerland (if you are located in this jurisdictions at the time your pe resident)	(a) Right to Know/Access; (b) Right to Correct; (c) Right to Delete; (d) Right to Opt-Out of Sale; (e) Right to Opt-Out of Sharing for Targeted Advertising; (g) Right to Opt-Out of Automated Decision-making or Profiling; (h) Right Against Discrimination; (i) Right to Portability; (j) Right to Object; (k) Right to Restrict; (l) Right to Withdraw Consent; and (n) Right to Lodge a Complaint.
