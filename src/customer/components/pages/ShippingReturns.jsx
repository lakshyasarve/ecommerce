...
Starting on July 25, 2019, Kiah Hygiene is partnering with Global-E to ship orders outside of the United States Delivery Duty Paid (DDP). Duties and taxes to your respective country will be displayed as a separate line item in your Check Out cart. All duties paid at check out are not collected by Kiah Hygiene; they are passed directly to your local customs office.
<div className="line-spacer"></div>
...
<div className="line-spacer"></div>
Currently, all International orders are FINAL SALE and may not be returned or exchanged. Kiah Hygiene is not responsible for international shipments lost in transit. </h6>
...
<h6>Returns will not be processed unless they go through our Returns Manager portal. If you are having issues with the portal, please reach out to us at hello@shopkiah.in.
<div className="line-spacer"></div>
...
<div className="line-spacer"></div>
International orders are final sale only and may not be returned or exchanged. Kiah Hygiene is not responsible for international shipments lost in transit.
<div className="line-spacer"></div>
The merchandise must be returned in the same condition in which it was shipped to receive a refund. This includes the original packaging and the box it came in. Kiah Hygiene boxes should not be used as the actual shipping box.
<div className="line-spacer"></div>
Please note, original and return shipping fees will not be credited back upon return.
<div className="line-spacer"></div>
Please make sure your items are returned new, unused and with all Kiah Hygiene and designer garment tags still attached. Returns that do not meet our policy will not be accepted and will be sent back to you.
<div className="line-spacer"></div>
